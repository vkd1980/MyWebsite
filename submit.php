...
if ((isset($_POST["submitted_form"])) && ($_POST["submitted_form"] == "image_upload_form")) {
	...
	if (($_FILES["image_upload_box"]["type"] == "image/jpeg" || $_FILES["image_upload_box"]["type"] == "image/pjpeg" || $_FILES["image_upload_box"]["type"] == "image/gif" || $_FILES["image_upload_box"]["type"] == "image/x-png") && ($_FILES["image_upload_box"]["size"] < 4000000))
	{
		...
		if($image_width>$max_upload_width || $image_height >$max_upload_height){
			...
			//move_uploaded_file($new_image,"img/8147226774.jpg") ; // Moving Uploaded file
		...
		header("Location: submit.php?upload_message=image uploaded&upload_message_type=success&show_image=".$remote_file);
		exit;
	}
	else{
...
<p><img src="img/<?php echo $_REQUEST['show_image'];?>" /></p>
<?php }?>
