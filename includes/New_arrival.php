      ...
      <div class="col-md-3 col-sm-4">
		...
		<div class="newarrival"> <img src="../img/neww.png"/></div>	
          ...
          <div class="item-details">
            ...
            <div class="button pull-right"><a href="../'.strtolower(preg_replace('#[ -]+#', '-',preg_replace("/[^a-zA-Z0-9\s]/", "",  $rows['categories_name']))).'-c-'.$rows['master_categories_id'].'/'.strtolower(preg_replace('#[ -]+#', '-',preg_replace("/[^a-zA-Z0-9\s]/", "",  $rows['products_name']))).'-p-'.$rows['products_id'].'.html">Detailss</a></div>
            <div class="clearfix"></div>
          </div>
        </div>
      </div>';
