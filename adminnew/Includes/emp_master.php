...
if($count > 0) {
	...
	$Emp_Role = isset($_REQUEST['Emp_Role']) ? mysql_real_escape_string($_REQUEST['Emp_Role']) : '';
		...
		$query= "INSERT INTO `tbl_emp_master` (`Emp_Code`,`Emp_Name`,`Emp_Pass`,`Emp_Address`,`Emp_State`,`Emp_Country`,`Emp_Phone`,`Emp_Email`,`Emp_Role`) VALUES ('" .$Emp_Code. "','" .$Emp_Name. "','" .md5($Emp_Pass). "','" .$Emp_Address. "','" .$Emp_State. "','" .$Emp_Country. "','" .$Emp_Phone. "','" .$Emp_Email. "','" .$Emp_Role. "')";
...
echo json_encode($db->updatedb($query));
	...
	$result = $db->selectwhere( 'tbl_emp_master', "Emp_Code=$selname");
