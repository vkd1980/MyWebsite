			  ...
			  <div class="col-md-9 col-sm-9">
				...
				<!--<ul class="breadcrumb">
				  ...
				  <?php echo breadcrumbs();?>
									...
									<!-- Title -->
									  <h4 class="pull-left">Publishers >>> <?php echo $PgHeading ;?></h4>


												  <!-- Sorting -->
													<div class="form-group pull-right">                               
														<select class="form-control" id="ddlViewBy">
														<option id="all">Sort By</option>
...
<div class="btn-info" id="nomore"><h3 style="color:#FFFFFF" align="center"><span class="fa fa-ban"></span> No more records!</h3></div>
